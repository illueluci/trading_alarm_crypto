...
def close_price_later_and_percent(insert_close_price: list) -> tuple:
    ...
    return close_price_later, increase_percent
...
def make_csv_mod_and_last_row(mod_destination, last_row_destination, input_csv_directory, method_of_download):
    ...
    dataset[f"Close Price {INTERVAL} hours later"], dataset["Increase %"] = close_price_later_and_percent(close_price)
...
if __name__ == "__main__":
    for stock in stock_list:
        make_csv_mod_and_last_row("mod_csv/" + stock + "_mod.csv",
                                  "last_row_csv/" + stock + "_last_row.csv",
